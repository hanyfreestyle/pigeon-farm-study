...
| DEC-019 | 2026-08-18 | Resolve OQ-021 | فقد أحد الأبوين أثناء وجود بيض أو زغاليل يُعامل كـ **مسار رعاية طارئ (Emergency Rearing Workflow)** متعدد النتائج؛ يمكن أن يستمر الوالد الباقي، أو يحدث نقل إلى زوج حاضن/مربي بديل، أو تستخدم الحضانة الصناعية/التغذية اليدوية أو رعاية خاصة إذا كانت متاحة، أو تفشل الدورة. لا يتغير النسب الوراثي بتغير من يقوم بالحضانة أو التربية. | لا توجد استجابة واحدة صحيحة لكل مرحلة وعمر وظرف، والقرار النهائي تشغيلي لدى المربي/مدير المزرعة. | يجب التمييز لاحقًا بين Planned Foster Transfer وEmergency Foster Transfer، وحمل متطلبات معلومات الوفاة والنقل والرعاية والنتيجة إلى Phase 2 وPhase 3 دون تحويلها الآن إلى تصميم بيانات. | Approved |
...
| FRQ-010 | مسار الطوارئ عند فقد أحد الأبوين أثناء وجود بيض/زغاليل | Phase 2 / Phase 3 | Identified | مبدأ تعدد مسارات الإنقاذ معتمد؛ تفاصيل الانتشار والممارسة المحلية تحتاج تحققًا. |
...
## حالة الأسئلة المفتوحة بعد إغلاق جولة الحل الأولى

- **محسومة كمبدأ/توجه للمشروع:** OQ-001, OQ-002, OQ-003, OQ-004, OQ-006, OQ-007, OQ-008, OQ-010, OQ-011, OQ-012, OQ-013, OQ-014, OQ-016, OQ-017, OQ-018, OQ-021.
- **مجابة جزئيًا وتحتاج تحققًا ميدانيًا/سوقيًا:** OQ-009, OQ-015, OQ-019, OQ-020.
- **مؤجلة وتحتاج تحققًا محليًا:** OQ-005.
- **موضوعات اختيارية/مستقبلية حُسم اتجاهها الحالي:** OQ-011, OQ-012, OQ-013.
- **Open Questions Resolution Round 1 مكتملة على مستوى اتجاهات المجال/المشروع، بينما Field Validation ما زالت قائمة حيث نُص عليها.**
...
- **آخر مهمة مكتملة:** Resolve OQ-021 + Open Questions Resolution Round 1 Closure.
- **الإجراء التالي الموصى به:** **مراجعة المستخدم واعتماده قبل Phase 2**.
